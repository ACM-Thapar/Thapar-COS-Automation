...
class ServerRequests {
  final String _url = 'secret-falls-79208.herokuapp.com';

// TODO: CHECK TITLES
  Future<bool> registerGoogle(AppUser appUser) async {
    print('GsignUp SENT');
    http.Response res = await http.post(
      Uri.https(_url, '/api/auth/firebase-signup'),
  ...
  Future<bool> registerForm(AppUser appUser) async {
    ...
    http.Response res = await http.post(
      Uri.https(_url, '/api/auth/signup'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
      },
      body: jsonEncode(<String, String>{
  ...
  Future<bool> checkOTP(String otp) async {
    ...
    http.Response res = await http.post(
      Uri.https(_url, '/api/auth/verify-otp'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
  ...
  Future<bool> regenerateOtp() async {
    ...
    http.Response res = await http.put(
      Uri.https(_url, '/api/auth/regenerate-otp'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'authorization': 'Bearer ${store.getString('token')}',
      },
  ...
  Future<bool> updateProfile(AppUser appUser) async {
    ...
    http.Response res = await http.put(
      Uri.https(_url, '/api/auth/complete-profile'),
      headers: <String, String>{
        'Content-Type': 'application/json; charset=UTF-8',
        'authorization': 'Bearer ${store.getString('token')}',
      },
